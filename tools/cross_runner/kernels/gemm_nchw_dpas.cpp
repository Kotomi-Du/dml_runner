...
)
{
	...
	const uint32_t thread_id_0 = gidX * tidX + gidX;
	const uint32_t thread_id_1 = gidY * tidY + gidY;
	...
	for( int step = 0; step < SIZE_K; step += TILE_K)
	{
		...
		for(int row = 0; row < 8; row++)
		{
			...
			readB1_m.select<1,1,8,2>(row, 0).format<U32>() = cm_load<U32, 4, DataSize::Default, CacheHint::Cached, CacheHint::Cached>(surface_input_b, read_offset_b);  
			readB1_m.select<1,1,8,2>(row, 1).format<U32>() = cm_load<U32, 4, DataSize::Default, CacheHint::Cached, CacheHint::Cached>(surface_input_b, read_offset_b + SIZE_N* SIZE_OF_HF16_BYTE);
			readB2_m.select<1,1,8,2>(row, 0).format<U32>() = cm_load<U32, 4, DataSize::Default, CacheHint::Cached, CacheHint::Cached>(surface_input_b, read_offset_b + 8* SIZE_OF_HF16_BYTE);
			readB2_m.select<1,1,8,2>(row, 1).format<U32>() = cm_load<U32, 4, DataSize::Default, CacheHint::Cached, CacheHint::Cached>(surface_input_b, read_offset_b + SIZE_N* SIZE_OF_HF16_BYTE + 8* SIZE_OF_HF16_BYTE );
			readB3_m.select<1,1,8,2>(row, 0).format<U32>() = cm_load<U32, 4, DataSize::Default, CacheHint::Cached, CacheHint::Cached>(surface_input_b, read_offset_b + 8 * 2* SIZE_OF_HF16_BYTE);
			readB3_m.select<1,1,8,2>(row, 1).format<U32>() = cm_load<U32, 4, DataSize::Default, CacheHint::Cached, CacheHint::Cached>(surface_input_b, read_offset_b + SIZE_N* SIZE_OF_HF16_BYTE + 8 * 2* SIZE_OF_HF16_BYTE);
			readB4_m.select<1,1,8,2>(row, 0).format<U32>() = cm_load<U32, 4, DataSize::Default, CacheHint::Cached, CacheHint::Cached>(surface_input_b, read_offset_b + 8 * 3* SIZE_OF_HF16_BYTE);
			readB4_m.select<1,1,8,2>(row, 1).format<U32>() = cm_load<U32, 4, DataSize::Default, CacheHint::Cached, CacheHint::Cached>(surface_input_b, read_offset_b + SIZE_N* SIZE_OF_HF16_BYTE + 8 * 3 * SIZE_OF_HF16_BYTE);
